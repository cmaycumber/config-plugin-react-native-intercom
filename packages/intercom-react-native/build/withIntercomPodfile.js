...
exports.updateDeploymentTargetXcodeProject = exports.updateDeploymentTargetPodfile = exports.withIntercomPodfile = void 0;
const config_plugins_1 = require("@expo/config-plugins");
const fs_1 = require("fs");
const path_1 = __importDefault(require("path"));
const semver_1 = __importDefault(require("semver"));
const withIntercomPodfile = (config, props) => {
...
const withIosDeploymentTargetPodfile = (config, props) => {
    return (0, config_plugins_1.withDangerousMod)(config, [
        ...
        async (config) => {
            ...
            let contents = await fs_1.promises.readFile(podfile, "utf8");
            contents = updateDeploymentTargetPodfile(contents, props.deploymentTarget);
            await fs_1.promises.writeFile(podfile, contents);
            return config;
        },
    ]);
};
